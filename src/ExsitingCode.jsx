            ...
            <div className="flex items-center gap-4 text-xs lg:text-sm">
                ...
                <div className='relative'>
                    <input
                        type="text"
                        placeholder="SEARCH"
                        className="border border-gray-300 rounded-full pl-6 pr-12 py-3 bg-transparent text-gray-500 font-semibold outline-none placeholder-gray-400"
                    />
                ...
                <button
                    ...
                    className="relative border bg-black text-white font-semibold rounded-full px-6 py-3 uppercase hover:bg-gray-800 transition"
                >
                    <span>
                        Connect Wallet
                    </span>
