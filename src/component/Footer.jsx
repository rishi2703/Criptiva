  ...
  return (
    <footer className="bg-black text-white px-8 py-10" >
     <div > 
        ...
        <div className="flex gap-16 font-semibold mb-2 text-md">
          <div className="">
...
<div>
  ...
  <div className="flex flex-col md:flex-row justify-between items-center text-md gap-4">
      ...
      <div className="mt-6 flex flex-col md:flex-row justify-between text-md text-gray-500 gap-2">
